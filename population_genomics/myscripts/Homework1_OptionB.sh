...
#SBATCH --output=/users/n/m/nmphelan/projects/eco_genomics_2025/population_genomics/mylogs/%x_%j.out
...
#SBATCH --mail-user=nmphelan@uvm.edu
...
# mkdir ~/projects/eco_genomics_2025/population_genomics/myresults/ANGSD/PCA_ADMIX/Homework1

OUT="/users/n/m/nmphelan/projects/eco_genomics_2025/population_genomics/myresults/ANGSD/PCA_ADMIX/Homework1"
