...
print(c("The first 4 eigenvalues for K=2 explain the following variance:",var_K2[1:4]))

#K=3
var_K3 <- round(PCA_K3$values/sum(PCA_K3$values),3)
print(c("The first 4 eigenvalues for K=3 explain the following variance:",var_K3[1:4]))

#K=4
var_K4 <- round(PCA_K4$values/sum(PCA_K4$values),3)
print(c("The first 4 eigenvalues for K=4 explain the following variance:",var_K4[1:4]))

#K=5
var_K5 <- round(PCA_K5$values/sum(PCA_K5$values),3)
print(c("The first 4 eigenvalues for K=5 explain the following variance:",var_K5[1:4]))
```
...
Generating a figure for the write-up
```{r}
#K=2
K2P1P2=ggscatter(data_K2, x = "V1", y = "V2",
          color = "Pop",
          mean.point = TRUE,
          star.plot = TRUE,
          main="K=2") + 
...
#K=3
K3P1P2=ggscatter(data_K3, x = "V1", y = "V2",
          color = "Pop",
          mean.point = TRUE,
          star.plot = TRUE,
          main="K=3") +
...
#K=4
K4P1P2=ggscatter(data_K4, x = "V1", y = "V2",
          color = "Pop",
          mean.point = TRUE,
          star.plot = TRUE,
          main="Red spruce genetic PCA when K=4") +
...
#K=5
K5P1P2=ggscatter(data_K5, x = "V1", y = "V2",
          color = "Pop",
          mean.point = TRUE,
          star.plot = TRUE,
          main="Red spruce genetic PCA when K=5") +
...
#K=2
K2P1P3=ggscatter(data_K2, x = "V1", y = "V3",
          color = "Pop",
          mean.point = TRUE,
          star.plot = TRUE,
          main="Red spruce genetic PCA when K=2") +
...
#K=3
K3P1P3=ggscatter(data_K3, x = "V1", y = "V3",
          color = "Pop",
          mean.point = TRUE,
          star.plot = TRUE,
          main="Red spruce genetic PCA when K=3") +
...
#K=4
K4P1P3=ggscatter(data_K4, x = "V1", y = "V3",
          color = "Pop",
          mean.point = TRUE,
          star.plot = TRUE,
          main="K=4") +
...
#K=5
K5P1P3=ggscatter(data_K5, x = "V1", y = "V3",
          color = "Pop",
          mean.point = TRUE,
          star.plot = TRUE,
          main="K=5") +
...
ggarrange(K2P1P2, K3P1P2, 
          #K4P1P2, K5P1P2, K2P1P3, K3P1P3, 
          K4P1P3, K5P1P3, ncol = 2, nrow = 2)
