...
Adding in what I need from DESeq
...
```
Plotting the distribution of the results data
...
combined_plot
```
Plotting the relationship between these metrics
...
# Identify only significant DEGs 
...
Running REVIGO (like the paper from today)
